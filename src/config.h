...
#if RAZER_MOD == 1
#define DESKTOP_GUID "1111111-e738-63ff-1dc8-90e3b534c44a" //magic code
#endif
...
namespace config {
  ...
  struct sunshine_t {
...
#if RAZER_MOD == 1    
    std::string config_default_file;
#endif
    ...
    #if RAZER_MOD == 1
    std::string razer_pair_token;
    std::string razer_uuid;
    #endif
  };

#if RAZER_MOD == 1
  struct razerSetting_t {
    std::string IDPairing; // 0
  };
#endif
...
#if RAZER_MOD == 1
  extern razerSetting_t razerSettings;
#endif
