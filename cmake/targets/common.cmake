...
add_executable(RazerRemotePlayHost ${SUNSHINE_TARGET_FILES})
...
target_link_libraries(RazerRemotePlayHost ${SUNSHINE_EXTERNAL_LIBRARIES} ${EXTRA_LIBS})
target_compile_definitions(RazerRemotePlayHost PUBLIC ${SUNSHINE_DEFINITIONS})
set_target_properties(RazerRemotePlayHost PROPERTIES CXX_STANDARD 17
...
target_compile_options(RazerRemotePlayHost PRIVATE $<$<COMPILE_LANGUAGE:CXX>:${SUNSHINE_COMPILE_OPTIONS}>;$<$<COMPILE_LANGUAGE:CUDA>:${SUNSHINE_COMPILE_OPTIONS_CUDA};-std=c++17>)  # cmake-lint: disable=C0301
